...
describe MyHashSet do
  ...
  describe "set interaction methods" do
    ...
    describe "#symmetric_difference" do
      it "returns the elements contained in either `set1` or `set2`, but not both" do
        els = set1.symmetric_difference(set2)
    ...
    describe "#==" do
      ...
      # Should this be one test or three?
      it "returns true if `object` is a `MyHashSet`, has the same size as `set1`,
      and every member of `object` is a member of `set1`" do
