...
describe String do
  describe "#caesar" do
    ...
    it "encodes a sentence with capital letters and special characters" do
      expect("One if by land; two if by sea - Paul Revere".caesar(5)).to eq(
             "Tsj nk gd qfsi; ybt nk gd xjf - Ufzq Wjajwj")
    end
  end
end
